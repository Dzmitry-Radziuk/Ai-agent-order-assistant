# Снимок архитектуры — 13 августа 2026 года

Это исторический снимок структуры ветки `decompose_bot`, а не карта текущей ветки.
За актуальными владельцами модулей обращайтесь к
[`../.agents/PROJECT_MAP.md`](../.agents/PROJECT_MAP.md). Исполняемый код и тесты
имеют приоритет. Историю декомпозиции
