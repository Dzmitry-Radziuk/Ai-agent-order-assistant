...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Сбросить и начать заново", Intent.CLEAR_CART),
        ("Сбрось заявку и начни сначала", Intent.CLEAR_CART),
        ("Очистить черновик и начать сначала", Intent.CLEAR_CART),
        ("Удали всё и начни заново", Intent.CLEAR_CART),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Не сбрасывай заявку и не начинай заново",
        "Не очищай черновик и не начинай сначала",
        "Новый заказ 5 кг",
